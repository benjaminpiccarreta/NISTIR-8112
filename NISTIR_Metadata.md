...
There may be legal requirements or trust framework policies that require a specified purpose for the processing of data. Therefore, to avoid placing the RP in violation of any such requirements, it is beneficial for the AP and the RP to agree on whether a purpose is required for the processing of the attributes before the attributes are sent to the RP and the type of purpose required (e.g. subject consent, contract, legal obligation, public interest).
